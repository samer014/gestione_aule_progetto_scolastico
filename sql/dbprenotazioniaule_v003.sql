...
-- Dump della struttura di tabella dbprenotazioniaule.aule_libere
CREATE TABLE IF NOT EXISTS `aule_libere` (
...
-- Dump dei dati della tabella dbprenotazioniaule.aule_libere: ~838 rows (circa)
